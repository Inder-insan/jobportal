...
if (!function_exists("GetSQLValueString")) {
  function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "")
  {
    ...
    $theValue = stripslashes($theValue) ? stripslashes($theValue) : $theValue;
                ...
                <tr>
                  ...
                  <td><label>
                      <select name="cmbTitle" id="cmbTitle">
                        <option selected="selected">Select Job Title</option>
                        <?php
                        do {
                        ?>
...
WHERE jobseeker_reg.JobSeekId=application_master.JobSeekId and application_master.JobId='" . $Title . "'";
                ...
                ?>
                  <tr>
                    ...
                    <td class="style3">
                      <div align="left" class="style9 style5"><strong></strong><a href="ViewBiodata.php?JobSeekId=<?php echo $JobSeekId; ?>&AppId=<?php echo $Id; ?>&JobId=<?php echo $Title; ?>&Status=<?php echo $Status; ?>" style="text-decoration: none;">View</a></div>
                    </td>
                  </tr>
                <?php
                }
