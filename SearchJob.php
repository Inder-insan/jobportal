          ...
          <div class="article">
            ...
            <form id="form1" method="post" action="SearchJob.php">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><strong>Compnay Name:</strong></td>
                  <td><label>
                      <select name="cmbCompany" id="cmbCompany">
                      <option selected="selected">Select Company Name</option>
                        <?php
                        do {
                        ?>
                  ...
                  if ($totalRows_Recordset2 != 0) {
                    do { ?>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td><strong>Min Qualification</strong></td>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td><a href="Apply.php?JobId=<?php echo $row_Recordset2['JobId']; ?>" style="text-decoration: none;"><strong>Apply For Job</strong></a></td>
                        </tr>
