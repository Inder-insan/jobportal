    ...
    <div id="page" class="box">
      <div id="page-in" class="box">
        ...
        <div id="content">
          ...
          <!-- Article -->
          <div class="article">
            <h2><span>Employer Registration Form</span></h2>
            <div class="login">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield8">
                        ...
                        <span class="textfieldRequiredMsg">Enter Employer Name</span></span></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield7">
                        <select name="area of work" id="area of work">
                          <option selected="selected">Select Area of Work</option>
                          <option value="software">Software</option>
                          <option value="hardware">Hardware</option>
                        </select>
                        <span class="textfieldRequiredMsg">Enter Area of Work</span>
                      </span></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><label><span id="sprytextfield10">
                          <input type="password" name="txtPassword" id="txtPassword" placeholder="Choose your Password" />
                  ...
                  <tr>
                    ...
                    <td><select name="cmbQue" id="cmbQue">
                        <option selected="selected">Select your Question</option>
