        ...
        <div id="page" class="box">
            <div id="page-in" class="box">
                ...
                <div id="content">
                    ...
                    <!-- Article -->
                    <div class="article">
                        <h2><span>Our Job Seekers</span></h2>
                        ...
                        <table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#006699">
                            <tr>
                                <th height="32" bgcolor="#006699" class="style3">
                                    <div align="left" class="style9 style5 style2"><strong>JobSeeker Name</strong></div>
                                </th>

                                <th bgcolor="#006699" class="style3">
                                    <div align="left" class="style9 style5 style2"><strong>Address</strong></div>
                                </th>
                        ...
                        <div align="center"><a href="JobSeekerReg.php" style="text-decoration: none;"><strong>New Job Seeker? Register Here</strong></a> </div>
